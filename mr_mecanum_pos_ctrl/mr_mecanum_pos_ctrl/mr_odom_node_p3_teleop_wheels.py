...
class ODOM_Node_P3_Teleop_Wheels(Node): # <--- CHANGE ME
    def __init__(self):
        super().__init__("odom_node_p3_teleop_wheels") # <--- CHANGE ME
    ...
    def cmd_vel_callback(self, msg):
        ...
        self.w2 = msg.linear.y
        self.w3 = msg.angular.x
        self.w4 = msg.angular.y
...
def main():
    rclpy.init()
    node = ODOM_Node_P3_Teleop_Wheels() # <--- CHANGE ME
    try:
        rclpy.spin(node)
